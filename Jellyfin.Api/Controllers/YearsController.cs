...
public class YearsController : BaseJellyfinApiController
{
    ...
    public async Task<ActionResult<QueryResult<BaseItemDto>>> GetYears(
        ...
        [FromQuery] bool? enableImages = true)
    {
        ...
        var dtos = await Task.WhenAll(tuples.Select(i => _dtoService.GetItemByNameDtoAsync(i.Item1, dtoOptions, i.Item2, user))).ConfigureAwait(false);
