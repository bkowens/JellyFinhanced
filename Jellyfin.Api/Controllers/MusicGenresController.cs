...
public class MusicGenresController : BaseJellyfinApiController
{
    ...
    public async Task<ActionResult<QueryResult<BaseItemDto>>> GetMusicGenres(
        ...
        [FromQuery] bool enableTotalRecordCount = true)
    {
        ...
        return await RequestHelpers.CreateQueryResultAsync(result, dtoOptions, _dtoService, shouldIncludeItemTypes, user).ConfigureAwait(false);
    }
