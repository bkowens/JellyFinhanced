...
namespace MediaBrowser.Controller.Dto
{
    ...
    public interface IDtoService
    {
        ...
        Task<IReadOnlyList<BaseItemDto>> GetBaseItemDtosAsync(IReadOnlyList<BaseItem> items, DtoOptions options, User? user = null, BaseItem? owner = null);
        ...
        Task<BaseItemDto> GetItemByNameDtoAsync(BaseItem item, DtoOptions options, List<BaseItem>? taggedItems, User? user = null);
    }
}
